...
extern (C) int UIAppMain(string[] args) {
    ...
    Log.setFileLogger(new std.stdio.File("fish.log", "w"));

    // resource directory search paths
    // not required if only embedded resources are used
    string[] resourceDirs = [
        appendPath(exePath, "res/"), // when res dir is located at the same directory as executable
        appendPath(exePath, "res/hdpi/"), // when res dir is located at the same directory as executable
    ];
    ...
    static if (true) {
        ...
        contentLayout.fontFamily(FontFamily.SansSerif).fontFace("SimSun");
        ...
        mainMenu.fontFamily(FontFamily.SansSerif).fontFace("Consolas");
